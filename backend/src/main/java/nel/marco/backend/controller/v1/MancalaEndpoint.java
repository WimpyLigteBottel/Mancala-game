package nel.marco.backend.controller.v1;

import lombok.extern.slf4j.Slf4j;
import nel.marco.backend.controller.v1.model.Command;
import nel.marco.backend.controller.v1.model.ErrorMessage;
import nel.marco.backend.controller.v1.model.Match;
import nel.marco.backend.controller.v1.model.PlayerModel;
import nel.marco.backend.controller.v1.validator.MancalaEndpointValidator;
import nel.marco.backend.service.MancalaService;
import nel.marco.backend.service.exceptions.InvalidMoveException;
import nel.marco.backend.service.exceptions.MatchIsOverException;
import nel.marco.backend.service.exceptions.NotThatPlayerTurnException;
import nel.marco.backend.service.exceptions.UnknownPlayerException;
